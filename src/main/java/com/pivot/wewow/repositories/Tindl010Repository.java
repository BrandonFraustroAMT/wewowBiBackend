...
public interface Tindl010Repository extends CrudRepository<Tindl010, Tindl010Id>{
    ...
    @Query("SELECT new com.pivot.wewow.dto.Tindl010DTO(t.tindl010Id.empid, t2.dimid, t3.dimdesc, t.tindl010Id.lindidlin, " +
            ...
            "WHERE t.tindl010Id.empid = :empid")
    /* @Query("SELECT new com.pivot.wewow.dto.Tindl010DTO(t.tindl010Id.empid, t2.dimid, t3.dimdesc, t.tindl010Id.lindidlin, " +
            "t2.linddescc, t.indclasifi, " +
    ...
    List<Tindl010DTO> findDataDimensions(@Param("empid") Long empid);
